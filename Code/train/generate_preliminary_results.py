...
def create_screenshot_montage(episode_data: List[Dict], num_samples: int = 9, 
    ...
    for idx, ep in enumerate(sample_episodes):
        ...
        if screenshot_path and os.path.exists(screenshot_path):
            ...
            axes[idx].text(0.5, 0.5, f"Episode {ep['episode_num']}\n(No screenshot)", 
                          ha='center', va='center')
        axes[idx].axis('off')
...
def generate_preliminary_results(logs_dir: str = "logs/episodes", 
    ...
    print(f"\nSurvival Rates:")
    print(f"  Agent 0: {survival_stats['agent_0_survival_rate']:.2%} ({survival_stats['agent_0_survived_count']}/{survival_stats['total_episodes']})")
    print(f"  Agent 1: {survival_stats['agent_1_survival_rate']:.2%} ({survival_stats['agent_1_survived_count']}/{survival_stats['total_episodes']})")
    print(f"  Both: {survival_stats['both_survival_rate']:.2%} ({survival_stats['both_survived_count']}/{survival_stats['total_episodes']})")
    print(f"\nCooperation Score:")
    ...
    print(f"  - preliminary_results_summary.json")
    print(f"  - resource_distribution_heatmap.png")
    print(f"  - screenshot_montage.png")
    print(f"  - reward_curves/reward_curve.png")
    print(f"\nAggregated heatmaps saved to logs/heatmaps/")
    print(f"  - agent_0_heatmap.png")
    print(f"  - agent_1_heatmap.png")
    print("="*60)
